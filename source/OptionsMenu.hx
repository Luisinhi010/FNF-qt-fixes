...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCatagory> = [
		...
		new OptionCatagory("Appearence", [
			...
			#if desktop new RainbowFPSOption("Make the FPS Counter Rainbow (Only works with the FPS Counter toggeled on)"),
			#end
	...
	override function update(elapsed:Float)
	{
		...
		else
		{
			...
			versionShit.text = "Offset (Left, Right, Shift for slow): "
				+ truncateFloat(FlxG.save.data.offset, 2)
				+ " - Description - "
				+ currentDescription;
		}
